...
#
# Specify the folder that contains all the profile images
#
IMAGE_FOLDER = '/home/itell/free'  
...
f11.image = File.open(IMAGE_FOLDER + '/f/11.jpg')
f11.save
...
m11.image = File.open(IMAGE_FOLDER + '/m/11.jpg')
m11.save
...
f12.image = File.open(IMAGE_FOLDER + '/f/12.jpg')
f12.save
...
m12.image = File.open(IMAGE_FOLDER + '/m/12.jpg')
m12.save
...
f13.image = File.open(IMAGE_FOLDER + '/f/13.jpg')
f13.save
...
m13.image = File.open(IMAGE_FOLDER + '/m/13.jpg')
m13.save
...
f14.image = File.open(IMAGE_FOLDER + '/f/14.jpg')
f14.save
...
m14.image = File.open(IMAGE_FOLDER + '/m/14.jpg')
m14.save
...
f15.image = File.open(IMAGE_FOLDER + '/f/15.jpg')
f15.save
...
m15.image = File.open(IMAGE_FOLDER + '/m/15.jpg')
m15.save
...
f16.image = File.open(IMAGE_FOLDER + '/f/16.jpg')
f16.save
...
m16.image = File.open(IMAGE_FOLDER + '/m/16.jpg')
m16.save
...
f17.image = File.open(IMAGE_FOLDER + '/f/17.jpg')
f17.save
...
m17.image = File.open(IMAGE_FOLDER + '/m/17.jpg')
m17.save
...
f18.image = File.open(IMAGE_FOLDER + '/f/18.jpg')
f18.save
...
m18.image = File.open(IMAGE_FOLDER + '/m/18.jpg')
m18.save
...
f19.image = File.open(IMAGE_FOLDER + '/f/19.jpg')
f19.save
...
m19.image = File.open(IMAGE_FOLDER + '/m/19.jpg')
m19.save
...
f20.image = File.open(IMAGE_FOLDER + '/f/20.jpg')
f20.save
...
m20.image = File.open(IMAGE_FOLDER + '/m/20.jpg')
m20.save
...
f21.image = File.open(IMAGE_FOLDER + '/f/21.jpg')
f21.save
...
m21.image = File.open(IMAGE_FOLDER + '/m/21.jpg')
m21.save
...
f22.image = File.open(IMAGE_FOLDER + '/f/22.jpg')
f22.save
...
m22.image = File.open(IMAGE_FOLDER + '/m/22.jpg')
m22.save
...
f23.image = File.open(IMAGE_FOLDER + '/f/23.jpg')
f23.save
...
m23.image = File.open(IMAGE_FOLDER + '/m/23.jpg')
m23.save
...
f24.image = File.open(IMAGE_FOLDER + '/f/24.jpg')
f24.save
...
m24.image = File.open(IMAGE_FOLDER + '/m/24.jpg')
m24.save
...
f25.image = File.open(IMAGE_FOLDER + '/f/25.jpg')
f25.save
...
m25.image = File.open(IMAGE_FOLDER + '/m/25.jpg')
m25.save
...
f26.image = File.open(IMAGE_FOLDER + '/f/26.jpg')
f26.save
...
m26.image = File.open(IMAGE_FOLDER + '/m/26.jpg')
m26.save
...
f27.image = File.open(IMAGE_FOLDER + '/f/27.jpg')
f27.save
...
m27.image = File.open(IMAGE_FOLDER + '/m/27.jpg')
m27.save
...
f28.image = File.open(IMAGE_FOLDER + '/f/28.jpg')
f28.save
...
m28.image = File.open(IMAGE_FOLDER + '/m/28.jpg')
m28.save
...
f29.image = File.open(IMAGE_FOLDER + '/f/29.jpg')
f29.save
...
m29.image = File.open(IMAGE_FOLDER + '/m/29.jpg')
m29.save
...
f30.image = File.open(IMAGE_FOLDER + '/f/30.jpg')
f30.save
...
m30.image = File.open(IMAGE_FOLDER + '/m/30.jpg')
m30.save
...
f31.image = File.open(IMAGE_FOLDER + '/f/31.jpg')
f31.save
...
m31.image = File.open(IMAGE_FOLDER + '/m/31.jpg')
m31.save
...
f32.image = File.open(IMAGE_FOLDER + '/f/32.jpg')
f32.save
...
m32.image = File.open(IMAGE_FOLDER + '/m/32.jpg')
m32.save
...
f33.image = File.open(IMAGE_FOLDER + '/f/33.jpg')
f33.save
...
m33.image = File.open(IMAGE_FOLDER + '/m/33.jpg')
m33.save
...
f34.image = File.open(IMAGE_FOLDER + '/f/34.jpg')
f34.save
...
m34.image = File.open(IMAGE_FOLDER + '/m/34.jpg')
m34.save
...
f35.image = File.open(IMAGE_FOLDER + '/f/35.jpg')
f35.save
...
m35.image = File.open(IMAGE_FOLDER + '/m/35.jpg')
m35.save
...
f36.image = File.open(IMAGE_FOLDER + '/f/36.jpg')
f36.save
...
m36.image = File.open(IMAGE_FOLDER + '/m/36.jpg')
m36.save
...
f37.image = File.open(IMAGE_FOLDER + '/f/37.jpg')
f37.save
...
m37.image = File.open(IMAGE_FOLDER + '/m/37.jpg')
m37.save
...
f38.image = File.open(IMAGE_FOLDER + '/f/38.jpg')
f38.save
...
m38.image = File.open(IMAGE_FOLDER + '/m/38.jpg')
m38.save
...
f39.image = File.open(IMAGE_FOLDER + '/f/39.jpg')
f39.save
...
m39.image = File.open(IMAGE_FOLDER + '/m/39.jpg')
m39.save
...
f40.image = File.open(IMAGE_FOLDER + '/f/40.jpg')
f40.save
...
m40.image = File.open(IMAGE_FOLDER + '/m/40.jpg')
m40.save
...
f41.image = File.open(IMAGE_FOLDER + '/f/41.jpg')
f41.save
...
m41.image = File.open(IMAGE_FOLDER + '/m/41.jpg')
m41.save
...
f42.image = File.open(IMAGE_FOLDER + '/f/42.jpg')
f42.save
...
m42.image = File.open(IMAGE_FOLDER + '/m/42.jpg')
m42.save
...
f43.image = File.open(IMAGE_FOLDER + '/f/43.jpg')
f43.save
...
m43.image = File.open(IMAGE_FOLDER + '/m/43.jpg')
m43.save
...
f44.image = File.open(IMAGE_FOLDER + '/f/44.jpg')
f44.save
...
m44.image = File.open(IMAGE_FOLDER + '/m/44.jpg')
m44.save
...
f45.image = File.open(IMAGE_FOLDER + '/f/45.jpg')
f45.save
...
m45.image = File.open(IMAGE_FOLDER + '/m/45.jpg')
m45.save
...
f46.image = File.open(IMAGE_FOLDER + '/f/46.jpg')
f46.save
...
m46.image = File.open(IMAGE_FOLDER + '/m/46.jpg')
m46.save
...
f47.image = File.open(IMAGE_FOLDER + '/f/47.jpg')
f47.save
...
m47.image = File.open(IMAGE_FOLDER + '/m/47.jpg')
m47.save
...
f48.image = File.open(IMAGE_FOLDER + '/f/48.jpg')
f48.save
...
m48.image = File.open(IMAGE_FOLDER + '/m/48.jpg')
m48.save
...
f49.image = File.open(IMAGE_FOLDER + '/f/49.jpg')
f49.save
...
m49.image = File.open(IMAGE_FOLDER + '/m/49.jpg')
m49.save
...
f50.image = File.open(IMAGE_FOLDER + '/f/50.jpg')
f50.save
...
m50.image = File.open(IMAGE_FOLDER + '/m/50.jpg')
m50.save
